...
$hxClasses["Main"] = Main;
Main.__name__ = ["Main"];
Main.ueHandler = function(e) {
	haxe_Log.trace("event type: " + e.type,{ fileName : "Main.hx", lineNumber : 16, className : "Main", methodName : "ueHandler"});
	haxe_Log.trace("   target: " + Std.string(e.target),{ fileName : "Main.hx", lineNumber : 17, className : "Main", methodName : "ueHandler"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 18, className : "Main", methodName : "ueHandler"});
};
Main.meHandler = function(e) {
	haxe_Log.trace("event type: " + e.type,{ fileName : "Main.hx", lineNumber : 22, className : "Main", methodName : "meHandler"});
	haxe_Log.trace("   target: " + Std.string(e.target),{ fileName : "Main.hx", lineNumber : 23, className : "Main", methodName : "meHandler"});
	haxe_Log.trace("   button down: " + (e.buttonDown == null ? "null" : "" + e.buttonDown),{ fileName : "Main.hx", lineNumber : 24, className : "Main", methodName : "meHandler"});
	haxe_Log.trace("   touch event: " + (e.touchEvent == null ? "null" : "" + e.touchEvent),{ fileName : "Main.hx", lineNumber : 25, className : "Main", methodName : "meHandler"});
	haxe_Log.trace("   delta: " + e.delta + ", X:" + e.screenX + ", Y:" + e.screenY,{ fileName : "Main.hx", lineNumber : 26, className : "Main", methodName : "meHandler"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 27, className : "Main", methodName : "meHandler"});
};
Main.keHandler = function(e) {
	haxe_Log.trace("event type: " + e.type,{ fileName : "Main.hx", lineNumber : 31, className : "Main", methodName : "keHandler"});
	haxe_Log.trace("   target: " + Std.string(e.target),{ fileName : "Main.hx", lineNumber : 32, className : "Main", methodName : "keHandler"});
	haxe_Log.trace("   key code: " + e.keyCode,{ fileName : "Main.hx", lineNumber : 33, className : "Main", methodName : "keHandler"});
	haxe_Log.trace("   shift key: " + (e.shiftKey == null ? "null" : "" + e.shiftKey),{ fileName : "Main.hx", lineNumber : 34, className : "Main", methodName : "keHandler"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 35, className : "Main", methodName : "keHandler"});
};
Main.seHandler = function(e) {
	haxe_Log.trace("event type: " + e.type,{ fileName : "Main.hx", lineNumber : 39, className : "Main", methodName : "seHandler"});
	haxe_Log.trace("   target: " + Std.string(e.target),{ fileName : "Main.hx", lineNumber : 40, className : "Main", methodName : "seHandler"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 41, className : "Main", methodName : "seHandler"});
};
Main.main = function() {
	...
	c2.set_id("ta1");
	c2.set_text("scroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events;\n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; \n\t\t\tscroll & position events; scroll & position events; scroll & position events; scroll & position events; scroll & position events; ");
	c1.addComponent(c2);
	c1.set_id("sv1");
	c1.set_width(200.);
	c1.set_height(200.);
	...
	c11.set_width(200.);
	c11.set_height(200.);
	c11.set_text("keyboard events;");
	c0.addComponent(c11);
	var c12 = new haxe_ui_components_TextArea();
	c12.set_id("ta3");
	c12.set_width(200.);
	c12.set_height(200.);
	c12.set_text("mouse events;");
	c0.addComponent(c12);
	c0.set_script("");
	var ui = c0;
	ui.registerEvent("ready",Main.ueHandler);
	var sv1 = ui.findComponent("sv1",haxe_ui_containers_ScrollView);
	sv1.registerEvent("scrollstart",Main.seHandler);
	sv1.registerEvent("scrollstop",Main.seHandler);
	sv1.registerEvent("scrollchange",Main.seHandler);
	var ta1 = ui.findComponent("ta1",haxe_ui_components_TextArea);
	ta1.registerEvent("resize",Main.ueHandler);
	ta1.registerEvent("move",Main.ueHandler);
	var ta2 = ui.findComponent("ta2",haxe_ui_components_TextArea);
	ta2.registerEvent("keydown",Main.keHandler);
	ta2.registerEvent("keyup",Main.keHandler);
	ta2.registerEvent("change",Main.ueHandler);
	var ta3 = ui.findComponent("ta3",haxe_ui_components_TextArea);
	ta3.registerEvent("mousewheel",Main.meHandler);
	ta3.registerEvent("mousemove",Main.meHandler);
	ta3.registerEvent("mouseover",Main.meHandler);
	ta3.registerEvent("mouseout",Main.meHandler);
	ta3.registerEvent("mousedown",Main.meHandler);
	ta3.registerEvent("mouseup",Main.meHandler);
	ta3.registerEvent("click",Main.meHandler);
	haxe_ui_core_Screen.get_instance().addComponent(ui);
	haxe_Log.trace("Resize and move (related events will be called):",{ fileName : "Main.hx", lineNumber : 100, className : "Main", methodName : "main"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 101, className : "Main", methodName : "main"});
	ta1.set_width(250);
	ta1.set_height(250);
	ta1.set_top(10);
	ta1.set_left(10);
	haxe_Log.trace("Change some component's data (related events will be called):",{ fileName : "Main.hx", lineNumber : 111, className : "Main", methodName : "main"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 112, className : "Main", methodName : "main"});
	var _g = ta2;
	_g.set_text(_g.get_text() + "\n1st New Line...");
	var _g1 = ta2;
	_g1.set_text(_g1.get_text() + "\n2nd New Line...");
	haxe_Log.trace("Unregister event and change (nothing will be called).",{ fileName : "Main.hx", lineNumber : 119, className : "Main", methodName : "main"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 120, className : "Main", methodName : "main"});
	ta2.unregisterEvent("change",Main.ueHandler);
	var _g2 = ta2;
	_g2.set_text(_g2.get_text() + "\n3rd New Line...");
	haxe_Log.trace("Register some events via properies",{ fileName : "Main.hx", lineNumber : 128, className : "Main", methodName : "main"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 129, className : "Main", methodName : "main"});
	ta2.set_onChange(Main.ueHandler);
	ta2.set_onClick(Main.meHandler);
	haxe_Log.trace("Call events programmatically:",{ fileName : "Main.hx", lineNumber : 136, className : "Main", methodName : "main"});
	haxe_Log.trace("",{ fileName : "Main.hx", lineNumber : 137, className : "Main", methodName : "main"});
	ta1.dispatch(new haxe_ui_core_UIEvent("resize"));
	ta2.dispatch(js_Boot.__cast(new haxe_ui_core_KeyboardEvent("keyup") , haxe_ui_core_UIEvent));
	ta2.dispatch(new haxe_ui_core_UIEvent("change"));
	ta2.dispatch(js_Boot.__cast(new haxe_ui_core_MouseEvent("click") , haxe_ui_core_UIEvent));
	ta3.dispatch(js_Boot.__cast(new haxe_ui_core_MouseEvent("click") , haxe_ui_core_UIEvent));
};
Math.__name__ = ["Math"];
