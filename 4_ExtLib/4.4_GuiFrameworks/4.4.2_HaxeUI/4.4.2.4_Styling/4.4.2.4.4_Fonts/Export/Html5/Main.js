...
Main.main = function() {
	...
	app.ready(function() {
		...
		c1.set_id("lbl1");
		c1.set_text("My label text 1");
		c0.addComponent(c1);
		var c11 = new haxe_ui_components_Label();
		c11.set_id("lbl2");
		c11.set_text("My label text 2");
		c0.addComponent(c11);
		c0.set_script("");
		app.addComponent(c0);
		app.start();
...
haxe_ui_Toolkit.build = function() {
	...
	haxe_ui_themes_ThemeManager.get_instance().addStyleResource("default","res/css/defstyle.css");
