...
Main.main = function() {
	...
	app.ready(function() {
		...
		c1.set_text("Basic item renderer of DropDown:");
		c0.addComponent(c1);
		...
		c41.set_id("value");
		c3.addComponent(c41);
		var c42 = new haxe_ui_components_CheckBox();
		c42.set_id("flag");
		c3.addComponent(c42);
		...
		c11.addComponent(c2);
		c11.set_width(250.);
		c11.set_text("Select Item");
		c11.set_dataSource(new haxe_ui_data_DataSourceFactory().fromString("<data>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 1'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 2'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 3'/>\n\t\t</data>",haxe_ui_data_ArrayDataSource));
		c0.addComponent(c11);
		var c12 = new haxe_ui_components_Spacer();
		c12.set_height(20.);
		c0.addComponent(c12);
		var c13 = new haxe_ui_components_Label();
		c13.set_text("Basic item renderer of ListView:");
		c0.addComponent(c13);
		var c14 = new haxe_ui_containers_ListView();
		var c21 = new haxe_ui_core_ItemRenderer();
		var c31 = new haxe_ui_containers_HBox();
		var c43 = new haxe_ui_components_Image();
		c43.set_id("icon");
		c31.addComponent(c43);
		var c44 = new haxe_ui_components_Label();
		c44.set_id("value");
		c31.addComponent(c44);
		var c45 = new haxe_ui_components_CheckBox();
		c45.set_id("flag");
		c31.addComponent(c45);
		c31.set_percentWidth(100.);
		c21.addComponent(c31);
		c21.set_percentWidth(100.);
		c14.addComponent(c21);
		c14.set_width(150.);
		c14.set_height(150.);
		c14.set_dataSource(new haxe_ui_data_DataSourceFactory().fromString("<data>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 1'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 2'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 3'/>\n\t\t</data>",haxe_ui_data_ArrayDataSource));
		c0.addComponent(c14);
		var c15 = new haxe_ui_components_Spacer();
		c15.set_height(20.);
		c0.addComponent(c15);
		var c16 = new haxe_ui_components_Label();
		c16.set_text("Basic item renderer of TableView:");
		c0.addComponent(c16);
		var c17 = new haxe_ui_containers_TableView();
		var c22 = new haxe_ui_containers_Header();
		var c32 = new haxe_ui_components_Column();
		c32.set_id("c1");
		c32.set_width(200.);
		c32.set_height(30.);
		c32.set_text("Column 1");
		c22.addComponent(c32);
		var c33 = new haxe_ui_components_Column();
		c33.set_id("c2");
		c33.set_width(200.);
		c33.set_height(30.);
		c33.set_text("Column 2");
		c33.set_sortable(true);
		c22.addComponent(c33);
		c17.addComponent(c22);
		var c23 = new haxe_ui_core_ItemRenderer();
		var c34 = new haxe_ui_containers_HBox();
		var c46 = new haxe_ui_components_Image();
		c46.set_id("icon");
		c34.addComponent(c46);
		var c47 = new haxe_ui_components_Label();
		c47.set_id("value");
		c34.addComponent(c47);
		var c48 = new haxe_ui_components_CheckBox();
		c48.set_id("flag");
		c34.addComponent(c48);
		c34.set_height(40.);
		c34.set_percentWidth(100.);
		c23.addComponent(c34);
		c23.set_percentWidth(100.);
		c17.addComponent(c23);
		c17.set_width(401.);
		c17.set_height(200.);
		c17.set_dataSource(new haxe_ui_data_DataSourceFactory().fromString("<data>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Cell 1:1' c2='Cell 1:2'/>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Cell 2:1' c2='Cell 2:2'/>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Cell 3:1' c2='Cell 3:2'/>\n\t\t</data>",haxe_ui_data_ArrayDataSource));
		c0.addComponent(c17);
		c0.set_script("");
		app.addComponent(c0);
		app.start();
