...
Main.main = function() {
	...
	app.ready(function() {
		...
		c11.set_width(150.);
		c11.set_height(150.);
		c11.set_dataSource(new haxe_ui_data_DataSourceFactory().fromString("<data>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 1' action='Action 1'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 2' action='Action 2'/>\n\t\t\t<item icon='res/img/tuxIcon.png' value='Item 3' action='Action 3'/>\n\t\t</data>",haxe_ui_data_ArrayDataSource));
		c0.addComponent(c11);
		...
		var c31 = new haxe_ui_components_Column();
		c31.set_id("c1");
		c31.set_width(200.);
		c31.set_height(30.);
		c31.set_text("Column 1");
		c21.addComponent(c31);
		var c32 = new haxe_ui_components_Column();
		c32.set_id("c2");
		c32.set_width(200.);
		c32.set_height(30.);
		c32.set_text("Column 2");
		c32.set_sortable(true);
		c21.addComponent(c32);
		c14.addComponent(c21);
		var c22 = new haxe_ui_core_ItemRenderer();
		var c33 = new haxe_ui_containers_HBox();
		...
		c14.addComponent(c22);
		c14.set_width(401.);
		c14.set_height(200.);
		c14.set_dataSource(new haxe_ui_data_DataSourceFactory().fromString("<data>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Value 1:1' c2='Value 1:2' action='Action 1'/>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Value 2:1' c2='Value 2:2' action='Action 2'/>\n\t\t\t<row icon='res/img/tuxIcon.png' c1='Value 3:1' c2='Value 3:2' action='Action 3'/>\n\t\t</data>",haxe_ui_data_ArrayDataSource));
		c0.addComponent(c14);
		c0.set_script("");
		app.addComponent(c0);
		app.start();
