...
Main.main = function() {
	...
	app.ready(function() {
		...
		var c1 = new haxe_ui_components_DropDown();
		c1.set_id("dropdown1");
		c1.set_width(200.);
		c1.set_text("Select Item");
		c0.addComponent(c1);
		...
		c0.set_script("");
		var ui = c0;
		var dd1 = ui.findComponent("dropdown1",haxe_ui_components_DropDown);
		dd1.set_dataSource(ds);
		var lv1 = ui.findComponent("listview1",haxe_ui_containers_ListView);
		lv1.set_dataSource(ds);
		app.addComponent(ui);
		app.start();
	});
};
