...
Main.main = function() {
	...
	app.ready(function() {
		...
		c1.set_text("Filled in markup:");
		c0.addComponent(c1);
		var c11 = new haxe_ui_containers_ListView();
		c11.set_id("listview1");
		c11.set_width(200.);
		...
		c13.set_text("Filled in class:");
		c0.addComponent(c13);
		var c14 = new haxe_ui_containers_ListView();
		c14.set_id("listview2");
		c14.set_width(200.);
		c0.addComponent(c14);
		c0.set_script("");
		var ui = c0;
		var lv = ui.findComponent("listview2",haxe_ui_containers_ListView);
		lv.get_dataSource().add({ value : "Item 1"});
		lv.get_dataSource().add("Item 2");
		lv.get_dataSource().add(3);
		lv.get_dataSource().add(4.44);
		lv.get_dataSource().add(true);
		app.addComponent(ui);
		app.start();
	});
};
